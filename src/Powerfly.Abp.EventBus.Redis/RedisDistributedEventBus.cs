...
public class RedisDistributedEventBus : DistributedEventBusBase, ISingletonDependency
{
    ...
    protected IRedisMessageConsumer Consumer { get; private set; } = default!;
    ...
    {
        AbpRedisEventBusOptions = abpRedisEventBusOptions.Value;
    ...
    public void Initialize()
    {
        Consumer = MessageConsumerFactory.Create(
            AbpRedisEventBusOptions.TopicName,
            AbpRedisEventBusOptions.GroupName,
            AbpRedisEventBusOptions.ConnectionName);
    ...
    {
        var producer = ProducerPool.Get(AbpRedisEventBusOptions.ConnectionName);
